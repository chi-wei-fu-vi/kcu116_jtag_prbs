...
elaborate()
{
  xelab --relax --debug typical --mt auto -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_12 -L xil_defaultlib -L util_vector_logic_v2_0_1 -L jtag_axi -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_16 -L fifo_generator_v13_2_2 -L axi_data_fifo_v2_1_15 -L axi_crossbar_v2_1_17 -L gtwizard_ultrascale_v1_7_3 -L axi_protocol_converter_v2_1_16 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot drp_example xil_defaultlib.drp_example xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim drp_example -key {Behavioral:sim_1:Functional:drp_example} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/opt/Xilinx/Vivado/2018.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb drp_example.wdb xsim.dir)
